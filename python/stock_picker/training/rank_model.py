...
Does not overwrite day_session_return.pkl. Scores are relative ranks, not
percents -- morning serving takes top-K, not a 0.5% gate.
"""
...
def train_and_persist_rank_model(
    ...
    specs = [ModelSpec("lightgbm_rank", excluded_features=excluded, weight=1.0)]
